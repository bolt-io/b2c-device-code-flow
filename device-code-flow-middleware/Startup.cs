...
namespace device_code_flow_middleware
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string[] scopes = Configuration["AppSettings:Scope"].Split("");

            services.AddMicrosoftWebAppAuthentication(Configuration, "AzureAdB2C") 
                    .AddMicrosoftWebAppCallsWebApi(Configuration, scopes , configSectionName: "AzureAdB2C")
        ...
        {
            // TBD: Temporary HTTP log
            // TablesService tables = new TablesService();
            // tables.TraceHttpAsync(context.Request.Method, context.Request.Path.Value);
